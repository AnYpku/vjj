...
############
        ...
        #extraJets=[j for j in jets if not j in tagJets] # this will compeltely remove all tagJets, but we only want to remove the first two tagging jets 
