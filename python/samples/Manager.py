...
class Manager:
    ...
    def __init__(self , lst , update_html=False):
        ...
        self.all_samples[ '02DoubleMuData' ] = SampleList( "DoubleMuData"  , [ '/DoubleMuon/.*' ] , 'era' , color=1 , regions=['mm','gamma'])
        ...
        self.all_samples[ '08GJetsLODR' ] = SampleList( 'GJetsLO' , ['/GJets_DR-0p4_HT-(?P<htrange>[^_]*).*' ] , 'htrange' , color=2 , regions=['gamma','fake'])
        self.all_samples[ '09wgjj' ] = SampleList( 'WGJJ'  , ['/WGammaToJJGamma_TuneCP5_13TeV-amcatnloFXFX-pythia8*' ] , color=28 , regions=['gamma','fake'])
        self.all_samples[ '10zgjj' ] = SampleList( 'ZGJJ'  , ['/ZGammaToJJGamma_TuneCP5_13TeV-amcatnloFXFX-pythia8*' ] , color=28 , regions=['gamma','fake'])
        self.all_samples[ '11DYJetsNLO' ] = SampleList( 'DYJetsNLO' , [ '/DYJetsToLL_M-(?P<mrange>[^_]*).*amcatnlo.*']  , color=4 , regions=['ee','mm','gamma','fake'])
        self.all_samples[ '15DYJetsLO' ] = SampleList( 'DYJetsLO' , [ '/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8*']  , color=4 , regions=['ee','mm','gamma','fake'])
        self.all_samples[ '12Signal_INT' ] = SampleList('GJets_SM_INT'  , [ '/GJets_SM_5f_TuneCP5_INT_dipoleRecoil_13TeV-madgraph-pythia8*' ] , color=30 , regions=['gamma','fake'])
        self.all_samples[ '13MET' ] = SampleList( "MET"  , ['/MET/.*' ] , 'era' , color=1 , regions=['gamma'])
        self.all_samples[ '14Jet' ] = SampleList( "JetHT"  , ['/JetHT/.*' ] , 'era' , color=1 , regions=['gamma'])
        ...
        self.all_samples[ '19gg' ] = SampleList( 'GG_M80'  , ['/DiPhotonJetsBox_MGG-80.*' ] ,'njets' , color=28 , regions=['gamma','fake'])
        self.all_samples[ '22gg40' ] = SampleList( 'GG_M40_80'  , ['/DiPhotonJetsBox_M40_80.*' ] ,'njets' , color=28 , regions=['gamma','fake'])
        self.all_samples[ '23gg0' ] = SampleList( 'GG_M0_40'  , ['/DiPhotonJetsBox_MGG-0to40.*' ] ,'njets' , color=28 , regions=['gamma','fake'])
